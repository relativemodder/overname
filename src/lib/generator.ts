...
export const THEMES: ThemeConfig[] = [
  {
    ...
    words: [
      ...
      'KDO', 'Overlord', 'OverLordKDOne', 'Unix', 'Geek', 'UnixGeek',
    ],
  },
  {
    id: 'ddos',
  ...
  },
  {
    ...
    words: [
      ...
      'Asahi', 'Secureblue', 'Graphene', 'POSIX', 'XSI', 'SUS',
      'Bash', 'Zsh', 'Fish', 'Dash', 'TTY', 'PTY', 'Console',
      'Terminal', 'Ncurses', 'Tmux', 'Screen', 'Ptyxis',
      'Glibc', 'Musl', 'GCC', 'LLVM', 'Clang', 'Make', 'Cmake',
      'Meson', 'Autotools', 'Patch', 'Diff',
    ],
  },
  {
    id: 'unix',
    label: 'Unix',
    words: [
      'Unix', 'BSD', 'FreeBSD', 'OpenBSD', 'NetBSD', 'DragonFly',
      'Solaris', 'SunOS', 'AIX', 'HPUX', 'IRIX', 'Minix',
      'Plan9', 'Inferno', 'SystemV', 'SysV',
      'Grep', 'Awk', 'Sed', 'Ed', 'Vi', 'Ex', 'More', 'Less',
      'Yacc', 'Lex', 'M4', 'Trofi', 'Dc', 'Bc',
      'Pipe', 'Fork', 'Exec', 'Inode', 'Mount', 'Chroot',
      'Jail', 'Zone', 'ZFS', 'Dtrace', 'Ktrace', 'Strace',
      'Lsof', 'Fuser', 'NFS', 'RPC', 'Devfs', 'Procfs', 'Sysfs',
      'UnixTime', 'UnixEpoch', 'UnixSock', 'UnixUser',
      'UnixWizard', 'UnixGuru', 'UnixPunk', 'UnixChad',
      'UnixFreak', 'UnixNerd', 'UnixDev', 'UnixBro',
      'Unixoid', 'Unixporn', 'UnixHater', 'UnixCuck',
      'SingleUNIX', 'UNIX03', 'UnixWare', 'Tru64',
    ],
  },
  {
    id: 'geek',
    label: 'Geek',
    words: [
      'Geek', 'GeekMode', 'GeekOut', 'GeekSquad', 'GeekCode',
      'Geekdom', 'Geekery', 'GeekGod', 'GeekLord', 'GeekMaster',
      'GeekCore', 'GeekPorn', 'GeekZone',
      'Hacker', 'Hackerman', 'Hacktivist', 'HackThePlanet',
      'HackTheBox', 'HackThisSite',
      'Neo', 'Morpheus', 'Trinity', 'CyberPunk', 'CyberSpace',
      'CyberSec', 'Shadowrun', 'BladeRunner', 'Deckard',
      'Leet', 'L33t', '1337', '31337', 'H4x0r', 'H4ck',
      'Pwn', 'Pwned', 'Owned', 'Pwnt', 'Ownt',
      'Warez', 'Cracker', 'Keygen', 'Serial', 'NFO',
      'Scene', 'Release', 'Demo', 'Intro', 'Megademo',
      'BOFH', 'RootMe', 'RootAccess', 'RootShell',
      'GhostInTheShell', 'Elite', 'El1t3',
      'Punk', 'ScriptKiddie', 'Lamer', 'Phreak',
      'BlueBox', 'RedBox', 'BlackBox',
    ],
  },
  {
    id: 'hackintosh',
